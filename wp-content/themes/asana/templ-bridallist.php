...
?>
	...
	<section class="container">
        ...
        if ( !empty($aPostCustom['uni_bridallist_page_header_image'][0]) ) {
            $aPageHeaderAttachIds = explode(',', $aPostCustom['uni_bridallist_page_header_image'][0]);
		...
		<div class="contentWrap">
            <div class="pagePanel clear">
                <div class="pageTitle"><?php _e('Bridal list', 'asana') ?></div>
            </div>
