...
<body style="margin: 0;padding: 0;border: 0;border-top: 8px solid #5fc7ae;border-bottom: 8px solid #5fc7ae; font-size: 100%;font: inherit;vertical-align: baseline;background:transparent;font-family: 'Lato', sans-serif; font-size: 20px;color:#7f7f7f;font-weight:300; ">
	<div class="wrapper" style="display: block;margin:0 auto;width:600px;text-align:center;padding-top: 45px;padding-bottom: 55px;">
		<h1 style="margin:0;color:#333333;font-size: 56px; font-weight:300;"><?php _e( 'Hello!', 'asana' ) ?></h1>
		<p style="line-height: 34px;margin-bottom:50px;"><?php echo sprintf( __( 'This is copy of your event registration details <br>%s', 'asana' ), $sEventTitleVar ) ?></p>
		...
		<p style="line-height: 34px;margin-bottom:0px;"><?php _e( 'Feel free to contact us anytime in case you have any questions', 'asana' ) ?></p>
		<p style="line-height: 34px;margin-top:0px;"><?php _e( 'Contact info', 'asana' ) ?>:</p>
		<div class="contactInfo" style="padding-top:4px; text-align:center;">
			<span style="display: inline-block;padding-right: 12px; font-size: 16px;color:#7f7f7f;"><?php _e( 'tel', 'asana' ) ?>: $sPhone</span>
			<span style="display: inline-block;padding-left: 12px; font-size: 16px;color:#7f7f7f;"><?php _e( 'email', 'asana' ) ?>: $sEmail</span>
		</div>
	</div>
</body>
</html>