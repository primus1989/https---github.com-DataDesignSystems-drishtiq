...
Description: Creates custom post types and taxonomies that are used in our themes
Version: 1.2.5
...
function uni_add_cpt() {
	...
	$labels = array(
		'name' => __('Team', 'uni-cpt-tax'),
		'singular_name' => __('Team member', 'uni-cpt-tax'),
		'add_new' => __('New team member', 'uni-cpt-tax'),
		'add_new_item' => __('Add team member', 'uni-cpt-tax'),
		'edit_item' => __('Edit team member', 'uni-cpt-tax'),
		'new_item' => __('All team members', 'uni-cpt-tax'),
		'view_item' => __('View team member', 'uni-cpt-tax'),
		'search_items' => __('Search team members', 'uni-cpt-tax'),
		'not_found' =>  __('Team members not found', 'uni-cpt-tax'),
		'not_found_in_trash' => __('Team members not found in cart', 'uni-cpt-tax'),
		'parent_item_colon' => '',
		'menu_name' => __('Team', 'uni-cpt-tax')
	);
	...
	register_post_type( 'uni_team_member' , $args );
